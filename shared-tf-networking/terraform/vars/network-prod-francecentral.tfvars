...
subnets = {
  appservice = {
    address_prefixes = ["10.80.5.128/26"]
#    address_prefixes = ["10.223.244.0/26"]
  ...
  data = {
    address_prefixes = ["10.80.5.64/26"]
...
nsg_rules = {
  appservice = [
    {
      ...
      destination_address_prefixes = ["10.80.5.64/26"]
    },
    {
      ...
      source_address_prefixes      = ["10.80.5.64/26"]
      destination_address_prefixes = ["10.80.5.0/27"]
    }
  ]
  data = [
    {
  ...
  privateendpoint = [
    ...
    },
    {
      ...
      source_port_ranges           = ["*"]
      destination_port_ranges      = ["443"]
      source_address_prefixes      = ["10.4.7.0/24"]
      destination_address_prefixes = ["10.80.5.0/27"]
    }
  ]
}
